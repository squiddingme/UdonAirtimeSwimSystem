...
namespace Airtime.Player.Movement
{
    ...
    public class GrindDetectorSwimSystem : UdonSharpBehaviour
    {
        [HideInInspector] public PlayerControllerSwimSystem controller;
        ...
        public void OnTriggerStay(Collider other)
        {
            if (other != null)
            {
                if (other.gameObject.layer == trackLayer && controller.GetPlayerState() == STATE_AERIAL && controller.GetPlayerState() == STATE_SWIMMING && (!controller.grindingMustFall || controller.GetIsFalling()) && !controller.GetIsGrindingOnCooldown())
                {
...
#if !COMPILER_UDONSHARP && UNITY_EDITOR
    [CustomEditor(typeof(GrindDetectorSwimSystem))]
    public class DetectorEditorSwimSystem : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            PlayerControllerSwimSystem newController = (PlayerControllerSwimSystem)EditorGUILayout.ObjectField("Player Controller", detector.controller, typeof(PlayerControllerSwimSystem), true);
